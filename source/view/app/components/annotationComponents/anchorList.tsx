...
const AnchorList: React.FC<Props> = ({ anchors, snapshotCode, scrollInEditor }) => {
    ...
    return (
        <div className={cn({ [styles.AnchorListContainer]: anchors.length > 1 })}>
            {showingAnchors ? anchors.map((a: AnchorObject) => {
                return <Anchor
